<section class="rounded-4 bg-info overflow-hidden mb-5">
    <div class="row align-items-center g-0">
        ...
        <div class="col-md-7 slide-cat offset-xl-1 text-center text-md-start position-relative">
            ...
            <div class="shop-button-prev me-2 position-absolute bottom-0 btn btn-light">
