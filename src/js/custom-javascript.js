...
jQuery(document).ready(function ($) {
    ...
    function createProductCard(item) {
        return $(`
            <a href="${item.link}" class="list-group-item list-group-item-action d-flex align-items-center bg-opacity-10 bg-info rounded-4 mb-3 p-2 position-relative search-result-item">
