...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=E.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return i.enableDismissTrigger(E),e.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Qt);var Kt,Xt,Yt,Ut=Qt.exports;function Jt(e,t=.5,n=0){gsap.fromTo(e,{opacity:0,y:n},{opacity:1,y:0,duration:t,ease:"power2.out"})}function Gt(e,t=-20,n=.6){gsap.fromTo(e,{opacity:0,y:t},{opacity:1,y:0,duration:n,ease:"bounce.out"})}Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Yt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Xt||Yt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),jQuery(document).ready((function(e){let t;const n=e("#s"),i=e("#product-search-results"),s=e("#initial-search-msg"),o=e("#search-spinner"),r=e("#no-results-msg"),a=e("#error-msg"),l=[];function c(){[s,o,r,a].forEach((e=>e.addClass("d-none")))}function u(){l.forEach((e=>e.reverse())),l.length=0}n.length&&i.length&&(e("#search-overlay").on("shown.bs.modal",(function(){c(),i.empty(),s.removeClass("d-none"),Gt(s)})),e("#search-overlay").on("hidden.bs.modal",(function(){clearTimeout(t),n.val(""),u(),c()})),n.on("input",(function(){clearTimeout(t);const n=e(this).val().trim();if(n.length<3)return u(),c(),i.empty(),s.removeClass("d-none"),void Gt(s);u(),c(),i.empty(),o.removeClass("d-none"),function(e,t=1,n=1.2,i=.5){gsap.to(e[0],{rotation:360,repeat:-1,duration:t,ease:"linear"}),gsap.to(e[0],{scale:n,repeat:-1,yoyo:!0,duration:i,ease:"sine.inOut"})}(o.find(".spinner")),t=setTimeout((function(){e.ajax({url:dingoProductSearch.ajaxurl,type:"POST",dataType:"json",data:{action:"dingo_product_search",nonce:dingoProductSearch.nonce,term:n},success:function(t){if(u(),c(),i.empty(),!t.success||!t.data||0===t.data.length)return r.removeClass("d-none"),void Jt(r,.5,-10);const n=[];t.data.forEach((t=>{const s=e(`\n                            <a href="${t.link}" class="list-group-item list-group-item-action d-flex align-items-center border rounded mb-2 p-2 search-result-item">\n                                <img src="${t.image}" class="me-3 rounded" style="width:60px;height:60px;object-fit:cover;">\n                                <div>\n                                    <div class="fw-bold">${t.title}</div>\n                                    <div class="text-success">${t.price}</div>\n                                </div>\n                            </a>\n                        `);i.append(s),n.push(s),function(e,t=1.05,n=-5,i=.3){e.hover((()=>gsap.to(e[0],{scale:t,y:n,boxShadow:"0 12px 24px rgba(0,0,0,0.2)",duration:i})),(()=>gsap.to(e[0],{scale:1,y:0,boxShadow:"0 0 0 rgba(0,0,0,0)",duration:i})))}(s)}));const s=function(e,t={}){const{stagger:n=.1,yOffset:i=20,duration:s=.5,ease:o="power3.out",reverse:r=!1,fromBottom:a=!0}=t,l=gsap.timeline({paused:!0}),c=a?e.toArray().reverse():e.toArray();return r?l.to(c,{opacity:0,y:-i,scale:.95,duration:s,stagger:n,ease:o}):l.fromTo(c,{opacity:0,y:i,scale:.95},{opacity:1,y:0,scale:1,duration:s,stagger:n,ease:o}),l.play(),l}(e(n),{stagger:.08,yOffset:30,duration:.4,fromBottom:!0});l.push(s)},error:function(e,t,n){u(),c(),a.removeClass("d-none").text(`Ocurrió un error al buscar productos: ${n}`),Jt(a,.5,-10),function(e,t="#ff4d4f",n=.4){gsap.fromTo(e,{backgroundColor:t},{backgroundColor:"transparent",duration:n,repeat:1,yoyo:!0})}(a)}})}),400)})))})),e.Alert=T,e.Button=k,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=Lt,e.Offcanvas=jt,e.Popover=Bt,e.Scrollspy=zt,e.Tab=Vt,e.Toast=Ut,e.Tooltip=Rt}));
