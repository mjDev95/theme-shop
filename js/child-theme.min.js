...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(t,e,n,i){const s=t=>t&&"object"==typeof t&&"default"in t?t:{default:t},o=s(e),r=s(n),a=s(i),l="tab",c=".bs.tab",u=`hide${c}`,d=`hidden${c}`,f=`show${c}`,h=`shown${c}`,p=`click${c}`,g=`keydown${c}`,m=`load${c}`,_="ArrowLeft",b="ArrowRight",v="ArrowUp",y="ArrowDown",w="active",x="fade",E="show",A="dropdown",T=".dropdown-toggle",O=".dropdown-menu",C=":not(.dropdown-toggle)",k='.list-group, .nav, [role="tablist"]',L=".nav-item, .list-group-item",D='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',S=`.nav-link${C}, .list-group-item${C}, [role="tab"]${C}, ${D}`,j=`.${w}[data-bs-toggle="tab"], .${w}[data-bs-toggle="pill"], .${w}[data-bs-toggle="list"]`;class $ extends a.default{constructor(t){super(t),this._parent=this._element.closest(k),this._parent&&(this._setInitialAttributes(this._parent,this._getChildren()),o.default.on(this._element,g,(t=>this._keydown(t))))}static get NAME(){return l}show(){const t=this._element;if(this._elemIsActive(t))return;const e=this._getActiveElem(),n=e?o.default.trigger(e,u,{relatedTarget:t}):null;o.default.trigger(t,f,{relatedTarget:e}).defaultPrevented||n&&n.defaultPrevented||(this._deactivate(e,t),this._activate(t,e))}_activate(e,n){if(!e)return;e.classList.add(w),this._activate(t.getElementFromSelector(e));const i=()=>{"tab"===e.getAttribute("role")?(e.removeAttribute("tabindex"),e.setAttribute("aria-selected",!0),this._toggleDropDown(e,!0),o.default.trigger(e,h,{relatedTarget:n})):e.classList.add(E)};this._queueCallback(i,e,e.classList.contains(x))}_deactivate(e,n){if(!e)return;e.classList.remove(w),e.blur(),this._deactivate(t.getElementFromSelector(e));const i=()=>{"tab"===e.getAttribute("role")?(e.setAttribute("aria-selected",!1),e.setAttribute("tabindex","-1"),this._toggleDropDown(e,!1),o.default.trigger(e,d,{relatedTarget:n})):e.classList.remove(E)};this._queueCallback(i,e,e.classList.contains(x))}_keydown(e){if(![_,b,v,y].includes(e.key))return;e.stopPropagation(),e.preventDefault();const n=[b,y].includes(e.key),i=t.getNextActiveElement(this._getChildren().filter((e=>!t.isDisabled(e))),e.target,n,!0);i&&(i.focus({preventScroll:!0}),$.getOrCreateInstance(i).show())}_getChildren(){return r.default.find(S,this._parent)}_getActiveElem(){return this._getChildren().find((t=>this._elemIsActive(t)))||null}_setInitialAttributes(t,e){this._setAttributeIfNotExists(t,"role","tablist");for(const t of e)this._setInitialAttributesOnChild(t)}_setInitialAttributesOnChild(t){t=this._getInnerElement(t);const e=this._elemIsActive(t),n=this._getOuterElement(t);t.setAttribute("aria-selected",e),n!==t&&this._setAttributeIfNotExists(n,"role","presentation"),e||t.setAttribute("tabindex","-1"),this._setAttributeIfNotExists(t,"role","tab"),this._setInitialAttributesOnTargetPanel(t)}_setInitialAttributesOnTargetPanel(e){const n=t.getElementFromSelector(e);n&&(this._setAttributeIfNotExists(n,"role","tabpanel"),e.id&&this._setAttributeIfNotExists(n,"aria-labelledby",`#${e.id}`))}_toggleDropDown(t,e){const n=this._getOuterElement(t);if(!n.classList.contains(A))return;const i=(t,i)=>{const s=r.default.findOne(t,n);s&&s.classList.toggle(i,e)};i(T,w),i(O,E),n.setAttribute("aria-expanded",e)}_setAttributeIfNotExists(t,e,n){t.hasAttribute(e)||t.setAttribute(e,n)}_elemIsActive(t){return t.classList.contains(w)}_getInnerElement(t){return t.matches(S)?t:r.default.findOne(S,t)}_getOuterElement(t){return t.closest(L)||t}static jQueryInterface(t){return this.each((function(){const e=$.getOrCreateInstance(this);if("string"==typeof t){if(void 0===e[t]||t.startsWith("_")||"constructor"===t)throw new TypeError(`No method named "${t}"`);e[t]()}}))}}return o.default.on(document,p,D,(function(e){["A","AREA"].includes(this.tagName)&&e.preventDefault(),t.isDisabled(this)||$.getOrCreateInstance(this).show()})),o.default.on(window,m,(()=>{for(const t of r.default.find(j))$.getOrCreateInstance(t)})),t.defineJQueryPlugin($),$}(r(),c(),S(),w())}(qe);var Ve=qe.exports,Qe={exports:{}};
/*!
	  * Bootstrap toast.js v5.2.3 (https://getbootstrap.com/)
	  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(t,e,n,i){const s=t=>t&&"object"==typeof t&&"default"in t?t:{default:t},o=s(e),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(t,e){super(t,e),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const e=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),t.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(e,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const t=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(t,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(t,e){switch(t.type){case"mouseover":case"mouseout":this._hasMouseInteraction=e;break;case"focusin":case"focusout":this._hasKeyboardInteraction=e}if(e)return void this._clearTimeout();const n=t.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(t=>this._onInteraction(t,!0))),o.default.on(this._element,u,(t=>this._onInteraction(t,!1))),o.default.on(this._element,d,(t=>this._onInteraction(t,!0))),o.default.on(this._element,f,(t=>this._onInteraction(t,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(t){return this.each((function(){const e=E.getOrCreateInstance(this,t);if("string"==typeof t){if(void 0===e[t])throw new TypeError(`No method named "${t}"`);e[t](this)}}))}}return i.enableDismissTrigger(E),t.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Qe);var Ke,Xe,Ye,Ue=Qe.exports;function Je(t,e,n=50){t.text("");let i=0;const s=setInterval((()=>{t.append(e[i]),i++,i>=e.length&&clearInterval(s)}),n)}Ke=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Xe=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Ye=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Ke||Xe||Ye)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var t,e=location.hash.substring(1);/^[A-z0-9_-]+$/.test(e)&&(t=document.getElementById(e))&&(/^(?:a|select|input|button|textarea)$/i.test(t.tagName)||(t.tabIndex=-1),t.focus())}),!1),jQuery(document).ready((function(t){let e;const n=t("#s"),i=t("#product-search-results"),s=t("#search-overlay");n.length&&i.length&&s.length&&(s.on("shown.bs.modal",(()=>n.focus())),n.on("input",(function(){clearTimeout(e);const n=t(this).val().trim();if(n.length<3){i.empty().show();const e=t('<div class="p-2 text-muted"></div>');return i.append(e),void Je(e,"Escribe al menos 3 caracteres…",30)}i.empty().show();const s=t('<div class="p-2 text-primary fw-bold"></div>');i.append(s),Je(s,`🔍 Buscando... ${n}`,30),e=setTimeout((function(){i.empty().show();const e=t('<div class="p-2 text-center"><div class="spinner"></div> Buscando productos...</div>');i.append(e),function(t,e=1){gsap.to(t[0],{rotation:360,repeat:-1,duration:e,ease:"linear"})}(e.find(".spinner")),function(t,e=.3){gsap.fromTo(t,{opacity:0},{opacity:1,duration:e})}(e),t.ajax({url:dingoProductSearch.ajaxurl,type:"POST",dataType:"json",data:{action:"dingo_product_search",nonce:dingoProductSearch.nonce,term:n},success:function(e){if(i.empty().show(),!e.success||!e.data||0===e.data.length){const e=t('<div class="p-2 text-muted"></div>');return i.append(e),void Je(e,"No se encontraron productos.",30)}e.data.forEach(((e,n)=>{const s=t(`\n                            <a href="${e.link}" class="list-group-item list-group-item-action d-flex align-items-center border rounded mb-2 p-2 opacity-0">\n                                <img src="${e.image}" class="me-3 rounded" style="width:60px;height:60px;object-fit:cover;">\n                                <div>\n                                    <div class="fw-bold">${e.title}</div>\n                                    <div class="text-success">${e.price}</div>\n                                </div>\n                            </a>\n                        `);i.append(s),function(t,e=0,n=.5,i=-10){gsap.fromTo(t,{opacity:0,y:i},{opacity:1,y:0,duration:n,delay:e,ease:"power2.out"})}(s,.1*n),function(t,e=1.03,n="0 8px 16px rgba(0,0,0,0.2)"){t.hover((()=>gsap.to(t[0],{scale:e,boxShadow:n,duration:.3})),(()=>gsap.to(t[0],{scale:1,boxShadow:"0 0 0 rgba(0,0,0,0)",duration:.3})))}(s)}))},error:function(e,n,s){const o=t('<div class="p-2 text-danger"></div>');i.append(o),Je(o,`Ocurrió un error al buscar productos: ${s}`,30)}})}),400)})),s.on("hidden.bs.modal",(function(){n.val(""),i.empty().hide()})))})),t.Alert=T,t.Button=k,t.Carousel=I,t.Collapse=M,t.Dropdown=ve,t.Modal=Le,t.Offcanvas=je,t.Popover=Be,t.Scrollspy=ze,t.Tab=Ve,t.Toast=Ue,t.Tooltip=Re}));
